...
{
    public class Payment_Master1Controller : Controller
    {
        private readonly New_Stock_ManagementContext _context;

        public Payment_Master1Controller(New_Stock_ManagementContext context)
        {
            _context = context;
        }
        ...
        // GET: Payment_Master1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Payment_Master1/Create
